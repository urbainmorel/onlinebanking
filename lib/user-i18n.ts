...
const fr = {
  ...
  transferModal: {
    ...
    receivingCurrency: 'Devise de réception', accountOrClabe: 'Numéro de compte / CLABE / CPF / RUT',
    accountOrClabePlaceholder: 'CLABE, CPF, RUT, CCI ou IBAN',
...
const en: ExtraMessages = {
  ...
  transferModal: {
    ...
    receivingCurrency: 'Receiving currency', accountOrClabe: 'Account number / CLABE / CPF / RUT',
    accountOrClabePlaceholder: 'CLABE, CPF, RUT, CCI or IBAN', recipientInstitution: 'Declared recipient institution',
...
const de: ExtraMessages = {
  ...
  transferModal: {
    ...
    receivingCurrency: 'Empfangswährung', accountOrClabe: 'Kontonummer / CLABE / CPF / RUT',
    accountOrClabePlaceholder: 'CLABE, CPF, RUT, CCI oder IBAN', recipientInstitution: 'Angegebenes Empfängerinstitut',
...
const es: ExtraMessages = {
  ...
  transferModal: {
    ...
    receivingCurrency: 'Moneda de recepción', accountOrClabe: 'Número de cuenta / CLABE / CPF / RUT',
    accountOrClabePlaceholder: 'CLABE, CPF, RUT, CCI o IBAN', recipientInstitution: 'Entidad beneficiaria declarada',
...
const it: ExtraMessages = {
  ...
  transferModal: {
    ...
    receivingCurrency: 'Valuta di ricezione', accountOrClabe: 'Numero di conto / CLABE / CPF / RUT',
    accountOrClabePlaceholder: 'CLABE, CPF, RUT, CCI o IBAN', recipientInstitution: 'Istituto destinatario dichiarato',
...
const nl: ExtraMessages = {
  ...
  transferModal: {
    ...
    receivingCurrency: 'Ontvangstvaluta', accountOrClabe: 'Rekeningnummer / CLABE / CPF / RUT',
    accountOrClabePlaceholder: 'CLABE, CPF, RUT, CCI of IBAN', recipientInstitution: 'Opgegeven ontvangende instelling',
